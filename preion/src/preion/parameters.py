...
telescope_specs = {
    ...
    'SO-SAT': {'fsky':0.1, 'fwhm':17.0, 'noise':2.1, 'lmax': 300., 'lmin':30., 'Delta_ell':50,
               'ref':'https://arxiv.org/pdf/2103.02747',
    ...
    'CMB-S4-LAT': {'fsky':0.4, 'fwhm':1.0, 'noise': 1., 'lmin': 30., 'lmax': 4000., 'Delta_ell':500,
                   'ref':'https://arxiv.org/pdf/1907.04473',
                   'color': (0.5529411764705883, 0.6274509803921569, 0.796078431372549, 1.0)},
    'CMB-S4-SAT': {'fsky':0.03, 'fwhm':23., 'noise': 1., 'lmin': 20., 'lmax': 330., 'Delta_ell':50.,
