...
datafiles = ['data/P21_ksz_stats_healpy2.npy', 'data/P21_2_ksz_stats_healpy2.npy']
corrfiles = ['data/r21_ksz_stats_healpy2.npy', 'data/r21_2_ksz_stats_healpy2.npy']
...
fig.tight_layout()
fig.savefig('figures/cl_kszx21_vs_z2.png', dpi=220)
...
c_bar = plt.colorbar(sm, fraction=0.05, label=r'$x_e$', ax=ax)
fig.tight_layout()
fig.savefig('figures/r_kszx21_vs_z2.png', dpi=220)
...
c_bar = plt.colorbar(sm, fraction=0.05, label=r'$x_e$', ax=ax)
fig.tight_layout()
fig.savefig('figures/cl_kszx212_vs_z2.png', dpi=220)
...
c_bar = plt.colorbar(sm, fraction=0.05, label=r'$x_e$', ax=ax)
fig.tight_layout()
fig.savefig('figures/r_kszx212_vs_z2.png', dpi=220)